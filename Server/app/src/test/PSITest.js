...
module.exports = new Test(
	{
		...
		'insta_brand_none': new State(null, 'info_image', {
			description: "Tanulmányozd az alábbi Instagram posztot minimum tíz másodpercig!",
			next: "Következő",
			source: "/res/insta_brand_none.png",
			waitingTime: 10000
		}),
		'insta_brand_cong': new State(null, 'info_image', {
			description: "Tanulmányozd az alábbi Instagram posztot minimum tíz másodpercig!",
			next: "Következő",
			source: "/res/insta_brand_cong.png",
			waitingTime: 10000
		}),
		'insta_brand_incong': new State(null, 'info_image', {
			description: "Tanulmányozd az alábbi Instagram posztot minimum tíz másodpercig!",
			next: "Következő",
			source: "/res/insta_brand_incong.png",
			waitingTime: 10000
		}),
		'insta_covid_brand_none': new State(null, 'info_image', {
			description: "Tanulmányozd az alábbi Instagram posztot minimum tíz másodpercig!",
			next: "Következő",
			source: "/res/insta_covid_brand_none.png",
			waitingTime: 10000
		}),
		'insta_covid_brand_cong': new State(null, 'info_image', {
			description: "Tanulmányozd az alábbi Instagram posztot minimum tíz másodpercig!",
			next: "Következő",
			source: "/res/insta_covid_brand_cong.png",
			waitingTime: 10000
		}),
		'insta_covid_brand_incong': new State(null, 'info_image', {
			description: "Tanulmányozd az alábbi Instagram posztot minimum tíz másodpercig!",
			next: "Következő",
		...
		'debrief1_cong': new State('congruency_cong', 'info_text', {
			title: "Az instagram bejegyzésben egy HelloBody kozmetikum volt relámozva, egy Coco WOW arckrém volt látható a képen is.",
			next: "Következő",
		}),
